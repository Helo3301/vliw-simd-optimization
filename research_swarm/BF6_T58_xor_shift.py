"""
Theory 58: Combine XOR and shift into single pattern
Try to find patterns where XOR and shift can be combined
more efficiently in the hash function.
"""
...
class KernelBuilderT58:
    """T58: Combine XOR and shift - already optimized via interleaving
    The baseline uses FMA fusion for multiply+add patterns.
    XOR and shift are separate operations without a fused instruction."""
    def __init__(self):
    ...
    def build_kernel(self, forest_height: int, n_nodes: int, batch_size: int, rounds: int):
        # Baseline - no fused XOR+shift instruction available
...
if __name__ == "__main__":
    try:
        ...
        print(f"T58 RESULT: {cycles} cycles (baseline 1548)")
        print(f"T58 DELTA: {1548 - cycles}")
        print("T58 NOTE: No fused XOR+shift instruction; FMA already used for multiply+add")
