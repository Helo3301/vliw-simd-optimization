"""
Theory 94: Store val instead of idx between rounds
Hypothesis: Storing val instead of idx might reduce register pressure in critical path
(Will break correctness since we need idx for tree traversal)
"""
...
class KernelBuilderT94:
    """Theory 94: Store val instead of idx (baseline copy)"""
    def __init__(self):
...
if __name__ == "__main__":
    ...
    print(f"Theory 94 - Store val (baseline): {cycles} cycles")
