"""
Theory 91: Process lanes 0-3 separately from lanes 4-7
Hypothesis: Processing half-lanes separately might help with register pressure or scheduling
"""
...
class KernelBuilderT91:
    """Theory 91: Lane split processing - lanes 0-3, then 4-7"""
    def __init__(self):
    ...
    def build_kernel(self, forest_height: int, n_nodes: int, batch_size: int, rounds: int):
        # Using the baseline approach but with lane-split processing hint
        # This is mostly theoretical - in practice the hardware handles all 8 lanes uniformly
        # The real test is whether emitting operations for half-lanes gives scheduling advantage
        ...
        # Theory 91: Process lanes 0-3 first, then lanes 4-7
        # The operations are the same but interleaved differently
        # This is still using standard VALU ops which operate on all 8 lanes
        # The "lane split" is more conceptual here - we can't actually split lanes
        # in the ISA without scalar ops, which would be slower
        ...
        def emit_tile_interleaved(tile_idx):
            ...
            # THEORY 91: Process groups in alternating pattern
            # Instead of sequential 0-3, 4-7, etc, try interleaved
            GROUP_SIZE = 4
...
if __name__ == "__main__":
    ...
    print(f"Theory 91 - Lane Split: {cycles} cycles")
