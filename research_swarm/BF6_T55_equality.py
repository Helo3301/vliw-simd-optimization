"""
Theory 55: Use equality (==) for bounds check
Use equality comparison for bounds checking instead of less-than.
idx >= n_nodes could be idx == n_nodes for tight bounds.
"""
...
class KernelBuilderT55:
    """T55: Use equality for bounds - NOTE: this doesn't work semantically
    because idx can go beyond n_nodes by more than 1.
    The baseline already eliminates bounds checking via R10 skip."""
    def __init__(self):
    ...
    def build_kernel(self, forest_height: int, n_nodes: int, batch_size: int, rounds: int):
        # Just use the baseline - equality check doesn't help
...
if __name__ == "__main__":
    try:
        ...
        print(f"T55 RESULT: {cycles} cycles (baseline 1548)")
        print(f"T55 DELTA: {1548 - cycles}")
        print("T55 NOTE: Baseline already eliminates bounds checking via R10 skip")
