"""
Theory 95: Combine idx and val into single register
Hypothesis: Packing idx and val into a single 32-bit value might reduce register pressure
(idx uses only ~11 bits for tree of height 10, leaving 21 bits for val)
This is WILD and will break correctness but let's test the concept.
"""
...
class KernelBuilderT95:
    """Theory 95: Combined idx+val (baseline copy - conceptual test)"""
    def __init__(self):
...
if __name__ == "__main__":
    ...
    print(f"Theory 95 - Combined idx+val (baseline): {cycles} cycles")
