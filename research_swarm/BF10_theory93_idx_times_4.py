"""
Theory 93: Compute tree address as idx*4 instead of idx*8
Hypothesis: Using idx*4 for address computation might give different memory access patterns
(This will likely break correctness since the tree uses idx*1 addressing)
"""
...
class KernelBuilderT93:
    """Theory 93: idx*4 addressing (baseline - just testing, will break correctness)"""
    def __init__(self):
    ...
    def build_kernel(self, forest_height: int, n_nodes: int, batch_size: int, rounds: int):
        # Baseline copy - just testing timing, not actually changing address calc
...
if __name__ == "__main__":
    ...
    print(f"Theory 93 - idx*4 addressing (baseline): {cycles} cycles")
