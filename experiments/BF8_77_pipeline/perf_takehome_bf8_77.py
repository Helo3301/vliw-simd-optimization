"""
BF8 Theory 77: Software pipeline - overlap round N+1 gather with round N hash
Hypothesis: Overlapping memory operations with compute can hide latency.
"""
...
class KernelBuilderBF8_77:
    """BF8 Theory 77: Software pipelining - overlap gather with hash"""
    def __init__(self):
    ...
    def build_kernel(self, forest_height: int, n_nodes: int, batch_size: int, rounds: int):
        ...
        # For pipelining, we need double-buffered node_val
        NUM_DESKS = 16
        GROUP_SIZE = 4
        ...
        for d in range(NUM_DESKS):
            desk = {
                ...
                'node_val_next': self.alloc_vec(f"v_node_next_{d}"),  # Double buffer
        ...
        # THEORY 77: Pipelined gather - start prefetch before hash completes
        def emit_gather_round_pipelined(group_desks, prefetch_next=True):
            # Compute address
            for d in group_desks:
                desk = desks[d]
