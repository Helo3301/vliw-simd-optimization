"""
# Experiment B5-2: 32-desk single tile configuration

Instead of 2 tiles with 16 desks each, use 1 tile with 32 desks.
This should maximize ILP by having more independent work available
at any given time.
"""
...
class KernelBuilderB5_2:
    """B5-2: 32-desk single tile configuration"""
    def __init__(self):
    ...
    def build_kernel(self, forest_height: int, n_nodes: int, batch_size: int, rounds: int):
        ...
        # KEY CHANGE: 32 desks instead of 16
        NUM_DESKS = 32
        desks = []
        ...
        addr_tmp = [self.alloc_scratch(f"addr_tmp_{i}") for i in range(64)]  # 32*2
        ...
        def emit_all_desks():
            """Process all 32 desks in a single tile"""
            # Load all desk data
            for d in range(NUM_DESKS):
