"""
# Experiment B5-4: Different desk ordering within groups

Instead of sequential desk ordering (0,1,2,3), try interleaved order (0,2,1,3).
This may help with register pressure and scheduling by spreading out dependencies.
"""
...
class KernelBuilderB5_4:
    """B5-4: Interleaved desk ordering within groups"""
    def __init__(self):
    ...
    def build_kernel(self, forest_height: int, n_nodes: int, batch_size: int, rounds: int):
        ...
        def emit_tile_interleaved(tile_idx):
            ...
            for g in range(num_full_groups):
                base = g * GROUP_SIZE
                # KEY CHANGE: Interleaved desk order (0, 2, 1, 3 pattern)
                group = [base + 0, base + 2, base + 1, base + 3]
