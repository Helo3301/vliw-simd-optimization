"""
Theory 61: 4 tiles of 8 desks each (vs baseline 2 tiles of 16 desks)
More tiles = more tile overhead but potentially better scheduling within tiles
"""
...
class KernelBuilder:
    """Theory 61: 4 tiles of 8 desks each"""
    def __init__(self):
    ...
    def build_kernel(self, forest_height: int, n_nodes: int, batch_size: int, rounds: int):
        ...
        # CHANGED: 8 desks per tile instead of 16
        NUM_DESKS = 8
        desks = []
