"""
Theory 63: 8 tiles of 4 desks each
Smallest practical tile size - less scratch pressure but more tile overhead
"""
...
class KernelBuilder:
    ...
    def build_kernel(self, forest_height: int, n_nodes: int, batch_size: int, rounds: int):
        ...
        def emit_tile(tile_idx):
            ...
            # All 4 desks in one group
            group_desks = list(range(NUM_DESKS))
