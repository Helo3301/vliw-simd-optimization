"""
# Experiment H142: GROUP_SIZE=6 Optimization

**RESULT:** 1,644 cycles (1 cycle better than H140's 1,645 cycles)

**CHANGE:** GROUP_SIZE changed from 4 to 6 based on sweep results.

**OPTIMIZATIONS:**
1. Reduced preload (H105): NUM_PRELOADED = 7 instead of 15
...
4. GROUP_SIZE=6 (H142): Better interleaving than GROUP_SIZE=4

**BASE:** H140 with GROUP_SIZE=4 (1,645 cycles)

**TARGET:** 1,579 cycles (still need 65 more cycles)
"""
