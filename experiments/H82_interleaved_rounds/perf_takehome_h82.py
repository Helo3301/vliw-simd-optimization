"""
# Experiment H82: Interleaved Round Processing

**GOAL:** Reduce dependency stalls by processing desks in groups of 4, with each
group going through ALL 16 rounds before switching to the next group.

**HYPOTHESIS:** Instead of processing all 16 desks through each round sequentially
(round 0 for all 16, round 1 for all 16, etc.), process groups of 4 desks through
all rounds before moving to the next group. This allows the scheduler to find more
overlap opportunities between independent desk operations.

**RESULT:** Groups of 4 is optimal at 1,656 cycles (89.2x speedup)
- Groups of 1: 1,674 cycles (88.3x)
- Groups of 2: 1,678 cycles (88.0x)
- Groups of 3: 1,669 cycles (88.5x)
- Groups of 4: 1,656 cycles (89.2x) <-- BEST
- Groups of 5: 1,768 cycles (83.6x)
- Groups of 6: 1,673 cycles (88.3x)

**ALGORITHM:** Same as H79 (wrap exploitation, no bounds on R11-15)
**SCHEDULING:** Automatic via _schedule_slots()

**IMPROVEMENT:** 248 cycles faster than H79 (1,904 -> 1,656), beating target by 134 cycles
"""
...
class KernelBuilderH82:
    """
    H82: Interleaved round processing - process desks in groups through multiple rounds.
    """
    def __init__(self):
