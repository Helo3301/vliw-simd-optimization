"""
BF8 Theory 72: 3 desks per group
Hypothesis: Smaller groups (3) may reduce dependency chains and improve scheduling.
"""
...
class KernelBuilderBF8_72:
    ...
    def build_kernel(self, forest_height: int, n_nodes: int, batch_size: int, rounds: int):
        ...
        # THEORY 72: Use 3 desks per group
        NUM_DESKS = 15  # 5 groups of 3 to handle similar batch
        GROUP_SIZE = 3
        ...
        # 15 desks * 8 = 120 per tile, need ceil(256/120) = 3 tiles
