"""
# Experiment H144-F: Reverse Desk Order Within Groups

**GOAL:** Test if processing desks in reverse order within each group produces
better scheduling.
Instead of: desk 0,1,2,3 in group 0
Try: desk 3,2,1,0 in group 0

**HYPOTHESIS:** Different desk ordering may allow different overlapping patterns.
...
class KernelBuilderH144F:
    """
    H144-F: Reverse desk order within groups.
    """
    def __init__(self):
    ...
    def build_kernel(
        ...
        """Build kernel with REVERSED DESK ORDER IN GROUPS."""
        ...
        def emit_tile_interleaved(tile_idx):
            """Emit all operations with REVERSED DESK ORDER WITHIN GROUPS."""
            ...
            for g in range(num_groups):
                ...
                all_groups.append(list(reversed(group)))  # [3,2,1,0], [7,6,5,4], etc.
