"""
# Experiment H144-C: Odd/Even Desk Interleaving

**GOAL:** Test if processing desks in odd/even order produces better scheduling.
Instead of: desk 0,1,2,3 in each group
Try: desk 0,2,4,6 then desk 1,3,5,7 (odd/even interleaving)

**HYPOTHESIS:** Separating odd and even desks may reduce register pressure
and allow more parallel scheduling of operations.
...
class KernelBuilderH144C:
    """
    H144-C: Odd/even desk interleaving.
    Process desks 0,2,4,6,8,10,12,14 then 1,3,5,7,9,11,13,15 for each tile.
    """
    def __init__(self):
    ...
    def build_kernel(
        ...
        """Build kernel with ODD/EVEN DESK INTERLEAVING."""
        ...
        def emit_tile_interleaved(tile_idx):
            """Emit all operations with ODD/EVEN DESK INTERLEAVING."""
            ...
            # ===== ODD/EVEN DESK INTERLEAVING =====
            # Even desks: 0,2,4,6,8,10,12,14 (groups of 4)
            # Odd desks: 1,3,5,7,9,11,13,15 (groups of 4)
            even_groups = [
                [0, 2, 4, 6],
                [8, 10, 12, 14],
            ]
            ...
            for group_desks in even_groups + odd_groups:
