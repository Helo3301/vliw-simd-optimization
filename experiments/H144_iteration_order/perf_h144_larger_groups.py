"""
# Experiment H144-E: Larger Group Size (8 instead of 4)

**GOAL:** Test if larger group sizes produce better scheduling.
Instead of: 4 desks per group (4 groups)
Try: 8 desks per group (2 groups)

**HYPOTHESIS:** Larger groups may improve scheduling by allowing more
operations to be considered together for parallelization.
...
class KernelBuilderH144E:
    """
    H144-E: Larger group size (8 instead of 4).
    """
    def __init__(self):
    ...
    def build_kernel(
        ...
        """Build kernel with GROUP SIZE 8."""
        ...
        def emit_tile_interleaved(tile_idx):
            """Emit all operations with GROUP SIZE 8."""
            ...
            # ===== GROUP SIZE 8 =====
            GROUP_SIZE = 8  # Changed from 4
            num_groups = NUM_DESKS // GROUP_SIZE  # 2 groups
