"""
BF3 Theory 22: Skip hash stage 5 (test correctness)

This tests whether skipping the last hash stage affects correctness.
...
class KernelBuilderT22:
    """T22: Skip hash stage 5"""
    def __init__(self):
    ...
    def build_kernel(self, forest_height: int, n_nodes: int, batch_size: int, rounds: int):
        ...
        # MODIFIED HASH: Skip stage 5 (last stage)
        def emit_hash_interleaved_skip_stage5(group_desks):
            # Stage 0 with FMA
        ...
        def emit_rounds_0_1_2_fused(group_desks):
            ...
            emit_hash_interleaved_skip_stage5(group_desks)
            for d in group_desks:
                desk = desks[d]
...
if __name__ == "__main__":
    ...
    print(f"T22 Skip Stage 5: Cycles={cycles}, Correct={correct}")
