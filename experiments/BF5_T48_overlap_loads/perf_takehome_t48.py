"""
Theory 48: Overlap tile 1 loads with tile 0 hash

Hypothesis: Starting tile 1's data loads while tile 0 is still processing
could hide load latency by overlapping memory access with computation.
...
class KernelBuilderT48:
    """T48: Overlap tile 1 loads with tile 0 hash"""
    def __init__(self):
    ...
    def build_kernel(self, forest_height: int, n_nodes: int, batch_size: int, rounds: int):
        ...
        # T48: Process both tiles with overlapped loads - emit all instructions for
        # both tiles in an interleaved fashion to allow scheduler to overlap loads
        def emit_both_tiles_overlapped():
            # Load constants for both tiles upfront
