"""
# Experiment B3-4: Smaller groups (2 desks) for faster iteration

Maybe smaller groups = faster load/compute turnaround
"""
...
class KernelBuilderB3_4:
    """B3-4: 2 desks per group for faster turnaround"""
    def __init__(self):
