"""
BF3 Theory 25: Use 4-stage hash instead of 6

Test whether a 4-stage hash (keeping stages 0,2,4,5) maintains correctness.
This keeps all the FMA stages plus the final XOR stage.
Expected: INCORRECT - all 6 stages are needed for correct hash.
"""
...
class KernelBuilderT25:
    """T25: 4-stage hash (0,2,4,5) - skip stages 1 and 3"""
    def __init__(self):
    ...
    def build_kernel(self, forest_height: int, n_nodes: int, batch_size: int, rounds: int):
        ...
        # MODIFIED HASH: 4-stage (0,2,4,5) - skip stages 1 and 3
        def emit_hash_interleaved_4stage(group_desks):
            # Stage 0 with FMA
        ...
        def emit_rounds_0_1_2_fused(group_desks):
            ...
            emit_hash_interleaved_4stage(group_desks)
            for d in group_desks:
                desk = desks[d]
...
if __name__ == "__main__":
    ...
    print(f"T25 4-stage Hash: Cycles={cycles}, Correct={correct}")
