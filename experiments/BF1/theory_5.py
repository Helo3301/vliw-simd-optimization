"""
Theory 5: Interleave desks from different groups (0-0, 1-0, 0-1, 1-1...)
"""
...
class KernelBuilderT5:
    """Theory 5: Interleave desks from different groups"""
    def __init__(self):
    ...
    def build_kernel(self, forest_height: int, n_nodes: int, batch_size: int, rounds: int):
        ...
        def emit_tile_interleaved(tile_idx):
            ...
            # THEORY 5: Interleave desks from different groups
            # Instead of [0,1,2,3], [4,5,6,7], ... we do [0,4,8,12], [1,5,9,13], ...
            all_groups = []
            for pos in range(GROUP_SIZE):
                interleaved = [pos + g * GROUP_SIZE for g in range(num_full_groups)]
                all_groups.append(interleaved)
