"""
Theory 4: Process groups in reverse order (7,6,5,4,3,2,1,0)
"""
...
class KernelBuilderT4:
    """Theory 4: Process groups in reverse order"""
    def __init__(self):
    ...
    def build_kernel(self, forest_height: int, n_nodes: int, batch_size: int, rounds: int):
        ...
        def emit_tile_interleaved(tile_idx):
            ...
            # THEORY 4: Process groups in REVERSE order
            all_groups = []
            for g in range(num_full_groups - 1, -1, -1):  # 3,2,1,0 instead of 0,1,2,3
