"""
Theory 2: Emit all VALUs before all loads in each group
"""
...
class KernelBuilderT2:
    ...
    def build_kernel(self, forest_height: int, n_nodes: int, batch_size: int, rounds: int):
        ...
        # Theory 2: Emit all VALUs before all loads
        # Collect VALUs first, then loads
        def emit_gather_round_interleaved(group_desks):
            # ALL addr computations first (VALU)
            for d in group_desks:
                desk = desks[d]
