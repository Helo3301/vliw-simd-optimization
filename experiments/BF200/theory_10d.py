...
class KernelBuilderA1:
    ...
    def build_kernel(self, forest_height: int, n_nodes: int, batch_size: int, rounds: int):
        ...
        v_five = self.scratch_vconst(5, "v_five")  # Theory 10d: for R1/R12 branch vselect
        ...
        def emit_rounds_0_1_2_fused(group_desks):
            ...
            for d in group_desks:
                ...
                # Theory 10d: vselect for R1 branch instead of FMA
                self.emit("flow", ("vselect", desk['idx'], desk['bit0'], v_five, v_three))
        ...
        def emit_rounds_11_12_13_fused(group_desks):
            ...
            for d in group_desks:
                desk = desks[d]
                self.emit("valu", ("&", desk['tmp1'], desk['val'], v_one))
                # Theory 10d: vselect for R12 branch instead of FMA
                self.emit("flow", ("vselect", desk['idx'], desk['bit0'], v_five, v_three))
                self.emit("valu", ("+", desk['idx'], desk['idx'], desk['tmp1']))
