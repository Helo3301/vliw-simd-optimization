...
class KernelBuilderA1:
    ...
    def build_kernel(self, forest_height: int, n_nodes: int, batch_size: int, rounds: int):
        ...
        def emit_tile_interleaved(tile_idx):
            ...
            # Theory 218: Process groups in pairs with interleaved rounds
            for pair_idx in range(0, len(all_groups), 2):
                ...
                emit_rounds_0_1_2_3_fused(gA)
                if gB:
                    emit_rounds_0_1_2_3_fused(gB)
                ...
                emit_rounds_11_12_13_14_fused(gA)
                if gB:
                    emit_rounds_11_12_13_14_fused(gB)
