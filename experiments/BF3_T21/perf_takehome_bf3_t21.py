"""
BF3 Theory 21: Skip hash stage 0 (test correctness)

This tests whether skipping the first hash stage affects correctness.
Expected: INCORRECT - hash stages are required for proper hash function.
"""
...
class KernelBuilderT21:
    """T21: Skip hash stage 0"""
    def __init__(self):
    ...
    def build_kernel(self, forest_height: int, n_nodes: int, batch_size: int, rounds: int):
        ...
        # MODIFIED: Skip stage 0 FMA, use stages 1-5 only
        FMA_MULTIPLIERS = {2: 33, 4: 9}  # Removed stage 0
        v_hash_consts = []
        v_hash_shifts = []
        v_fma_mult = {}
        ...
        # MODIFIED HASH: Skip stage 0
        def emit_hash_interleaved_skip_stage0(group_desks):
        ...
        def emit_rounds_0_1_2_fused(group_desks):
            ...
            emit_hash_interleaved_skip_stage0(group_desks)
            for d in group_desks:
                desk = desks[d]
...
if __name__ == "__main__":
    ...
    print(f"T21 Skip Stage 0: Cycles={cycles}, Correct={correct}")
