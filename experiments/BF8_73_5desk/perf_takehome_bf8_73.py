"""
BF8 Theory 73: 5 desks per group
Hypothesis: 5 desks may balance VALU utilization vs dependency depth.
"""
...
class KernelBuilderBF8_73:
    ...
    def build_kernel(self, forest_height: int, n_nodes: int, batch_size: int, rounds: int):
        ...
        # THEORY 73: Use 5 desks per group
        NUM_DESKS = 15  # 3 groups of 5
        GROUP_SIZE = 5
