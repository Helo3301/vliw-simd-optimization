"""
# Experiment H143e: Best combination - vselect + stage-interleaved + try group size 3

Building on H143d (1613 cycles):
- vselect for 4-way selection
- Stage-interleaved hash emission
- Try group size 3 (since we have 6 VALU slots per cycle, maybe groups of 3 align better?)
"""
...
class KernelBuilderH143e:
    ...
    def build_kernel(self, forest_height: int, n_nodes: int, batch_size: int, rounds: int):
        ...
        def emit_tile_interleaved(tile_idx):
            ...
            # Try GROUP_SIZE = 3 (since 6 VALU slots / 2 ops per desk = 3 desks)
            GROUP_SIZE = 3
            num_full_groups = NUM_DESKS // GROUP_SIZE  # 5 groups
            ...
            for group_desks in all_groups:
                ...
                emit_round_1_interleaved(group_desks)  # Round 12
                emit_round_2_interleaved_vselect(group_desks)  # Round 13
