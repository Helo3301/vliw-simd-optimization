"""
# Experiment H143c: Try group size 2 with vselect optimization

Building on H143a (1618 cycles with vselect + group size 4)
Try group size 2 to see if it helps.
"""
...
class KernelBuilderH143c:
    """H143c: vselect + group size 2"""
    def __init__(self):
