"""
# Experiment H145d: H140 + Double-Pump + Shared Temps

**GOAL:** Combine the best ideas: H140's interleaved rounds, H87's double-pumped hash,
and H85's shared temps.

**HYPOTHESIS:** Double-pump improved H140 by 2 cycles (1,643 vs 1,645).
Shared temps alone hurt performance slightly (1,648).
Together, the double-pump might compensate for the shared temp conflicts.
...
class KernelBuilderH145d:
    """
    H145d: H140 + double-pumped hash + shared temps.
    """
    def __init__(self):
    ...
    def build_kernel(
        ...
        """
        Build kernel combining H140's interleaved rounds, H87's double-pump, and H85's shared temps.
        """
        ...
        # Per-desk vectors WITHOUT tmp1/tmp2 (using shared temps)
        NUM_DESKS = 16
        desks = []
        ...
        def emit_tile_interleaved(tile_idx):
            """H82-style interleaved rounds with H87 double-pump and H85 shared temps."""
