"""
# Experiment H127: Slim Vector Constants

**GOAL:** Reduce scratch space and init cycles by removing unused vector constants.

**HYPOTHESIS:** The v_zero vector constant is allocated but never used in the code.
Removing it saves:
- 1 scalar scratch slot for constant 0
- 8 vector slots for v_zero broadcast
- 1 const load + 1 vbroadcast operation
...
class KernelBuilderH127:
    """
    H127: Slim vector constants - remove unused v_zero.

    Based on H120 (fast init phase), but with unused vector constant removed:
    - v_zero was allocated but never used anywhere in the code
    - Removing it saves scratch space and init operations
    ...
    def build_kernel(
        ...
        H127: Slim vconst - removed unused v_zero.
        """
        ...
        # Vector constants - H127: removed unused v_zero
        ...
        print(f"  - H127: Slim vconst - removed unused v_zero")
